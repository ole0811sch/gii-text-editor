...
# 39 "/usr/include/c++/10/bits/std_abs.h" 2 3
...
typedef struct {
 ...
 int dyn_arr_char_insert(dyn_arr_char_t* dyn_arr, char element, size_t index);
 ...
 int dyn_arr_char_add(dyn_arr_char_t* dyn_arr, char element);
 ...
 int dyn_arr_char_remove(dyn_arr_char_t* dyn_arr, size_t index);
 ...
 int dyn_arr_char_pop(dyn_arr_char_t* dyn_arr);





 void dyn_arr_char_destroy(dyn_arr_char_t* dyn_arr);
 ...
 size_t dyn_arr_char_bsearch(dyn_arr_char_t* dyn_arr, char element);
# 113 "dyn_arr.h"
 size_t dyn_arr_char_bsearch_cb(dyn_arr_char_t* dyn_arr, char* cb_arg,
  signed int (*callback) (const char* cb_arg,
   const char* other));
...
typedef struct {
 ...
 int dyn_arr_line_create(size_t initial_capacity,
  unsigned char growth_factor_numerator,
  unsigned char growth_factor_denominator,
  dyn_arr_line_t* dyn_arr);
 ...
 int dyn_arr_line_insert(dyn_arr_line_t* dyn_arr, line_t element, size_t index);
 ...
 int dyn_arr_line_add(dyn_arr_line_t* dyn_arr, line_t element);
 ...
 int dyn_arr_line_remove(dyn_arr_line_t* dyn_arr, size_t index);
 ...
 int dyn_arr_line_pop(dyn_arr_line_t* dyn_arr);





 void dyn_arr_line_destroy(dyn_arr_line_t* dyn_arr);
 ...
 size_t dyn_arr_line_bsearch(dyn_arr_line_t* dyn_arr, line_t element);
# 113 "dyn_arr.h"
 size_t dyn_arr_line_bsearch_cb(dyn_arr_line_t* dyn_arr, line_t* cb_arg,
  signed int (*callback) (const line_t* cb_arg,
   const line_t* other));
...
void initialize_editor(const char* content) {
 ...
 unsigned int key;
 GetKey(&key);
 display_error("Test error, no memory", 5);
# 239 "editor.cpp"
}
...
# 316 "editor.cpp"
 ...
 switch (code) {
  ...
  case KEY_CHAR_0: ch = '0'; break;; case KEY_CHAR_1: ch = '1'; break;; case KEY_CHAR_2: ch = '2'; break;; case KEY_CHAR_3: ch = '3'; break;; case KEY_CHAR_4: ch = '4'; break;; case KEY_CHAR_5: ch = '5'; break;; case KEY_CHAR_6: ch = '6'; break;; case KEY_CHAR_7: ch = '7'; break;; case KEY_CHAR_8: ch = '8'; break;; case KEY_CHAR_9: ch = '9'; break;; case KEY_CHAR_DP: ch = '.'; break;; case KEY_CHAR_PLUS: ch = '+'; break;; case KEY_CHAR_MINUS: ch = '-'; break;; case KEY_CHAR_MULT: ch = '*'; break;; case KEY_CHAR_DIV: ch = '/'; break;; case KEY_CHAR_LPAR: ch = '('; break;; case KEY_CHAR_RPAR: ch = ')'; break;; case KEY_CHAR_COMMA: ch = '\x2c'; break;; case KEY_CHAR_POW: ch = '^'; break;; case KEY_CHAR_EQUAL: ch = '='; break;; case KEY_CHAR_LBRCKT: ch = '['; break;; case KEY_CHAR_RBRCKT: ch = ']'; break;; case KEY_CHAR_LBRACE: ch = '{'; break;; case KEY_CHAR_RBRACE: ch = '}'; break;; case KEY_CHAR_A: ch = 'A'; break;; case KEY_CHAR_B: ch = 'B'; break;; case KEY_CHAR_C: ch = 'C'; break;; case KEY_CHAR_D: ch = 'D'; break;; case KEY_CHAR_E: ch = 'E'; break;; case KEY_CHAR_F: ch = 'F'; break;; case KEY_CHAR_G: ch = 'G'; break;; case KEY_CHAR_H: ch = 'H'; break;; case KEY_CHAR_I: ch = 'I'; break;; case KEY_CHAR_J: ch = 'J'; break;; case KEY_CHAR_K: ch = 'K'; break;; case KEY_CHAR_L: ch = 'L'; break;; case KEY_CHAR_M: ch = 'M'; break;; case KEY_CHAR_N: ch = 'N'; break;; case KEY_CHAR_O: ch = 'O'; break;; case KEY_CHAR_P: ch = 'P'; break;; case KEY_CHAR_Q: ch = 'Q'; break;; case KEY_CHAR_R: ch = 'R'; break;; case KEY_CHAR_S: ch = 'S'; break;; case KEY_CHAR_T: ch = 'T'; break;; case KEY_CHAR_U: ch = 'U'; break;; case KEY_CHAR_V: ch = 'V'; break;; case KEY_CHAR_W: ch = 'W'; break;; case KEY_CHAR_X: ch = 'X'; break;; case KEY_CHAR_Y: ch = 'Y'; break;; case KEY_CHAR_Z: ch = 'Z'; break;; case KEY_CHAR_SPACE: ch = ' '; break;; case KEY_CHAR_VALR: ch = capitalization_once; break;; case KEY_CHAR_SQUARE: ch = capitalization_once; break;; case KEY_CHAR_ROOT: ch = capitalization_once; break;; case KEY_CHAR_PMINUS: ch = '\\'; break;; case KEY_CHAR_DQUATE: ch = '"'; break;;


  case KEY_CTRL_XTT: ch = '`'; break; case KEY_CTRL_OPTN: ch = capitalization_lock; break; case KEY_CTRL_UP: ch = -3; break; case KEY_CTRL_DOWN: ch = -4; break; case KEY_CTRL_LEFT: ch = -5; break; case KEY_CTRL_RIGHT: ch = -6; break; case KEY_CTRL_EXE: ch = '\n'; break; case KEY_CTRL_DEL: ch = '\x08'; break;
...
point_t char_point_to_point(char_point_t point) {
 if (point.x > ((127 - 0 + 1) / ((sizeof(font[0][0])) + 1)) || point.y > ((63 - 0 + 1) / ((sizeof(font[0]) / sizeof(font[0][0])) + 1))) {
  point_t err_point = { (unsigned char) -1, (unsigned char) -1 };
  return err_point;
 }

 point_t ret_val = { 0, 0 };
 ret_val.x += point.x * ((sizeof(font[0][0])) + 1) + 1;
 ret_val.y += point.y * ((sizeof(font[0]) / sizeof(font[0][0])) + 1) + 1;
 return ret_val;
}
...
static void add_new_line(size_t vline_begin) {
 ...
 dyn_arr_char_t* string = &(&(&lines)->arr[(&lines)->count - 1])->string;
...
static void initialize_lines(const char* str) {
 ...
 add_new_line(0);
 line_t* current_line = (&(&lines)->arr[(&lines)->count - 1]);
 unsigned char col = 0;
 size_t vline = 0;
 size_t i = 0;
 for (; str[i]; ++i) {
  if (str[i] == '\n') {
   add_new_line(vline);
   current_line = (&(&lines)->arr[(&lines)->count - 1]);
   col = 0;
  }
  else {


   if (col >= ((127 - 0 + 1) / ((sizeof(font[0][0])) + 1))) {
    col = 0;
    ++vline;
   }
...
void print_line(size_t line_i) {
 line_t* line = &lines.arr[line_i];
 size_t vvline_end;
 if (lines.count - 1 <= line_i)
  vvline_end = vlines_count;
 else
  vvline_end = lines.arr[line_i + 1].vline_begin;

 if (vvline_end > vvlines_begin + ((63 - 0 + 1) / ((sizeof(font[0]) / sizeof(font[0][0])) + 1)))
  vvline_end = vvlines_begin + ((63 - 0 + 1) / ((sizeof(font[0]) / sizeof(font[0][0])) + 1));

 size_t char_i = 0;
 unsigned char col = 0;
 size_t vline = vvlines_begin;
 ...
 while (char_i < line->string.count && vline < vvline_end) {
  ...
  print_char_xy(vline - vvlines_begin, col, line->string.arr[char_i], 0);
  ++char_i;
  ++col;
 }
}

void print_chars(unsigned char x, unsigned char y, const char* str) {
 char_point_t current_pos = { x, y };
 size_t i = 0;
 for (; str[i]; ++i) {
  if (current_pos.x >= ((127 - 0 + 1) / ((sizeof(font[0][0])) + 1))) {
   ++current_pos.y;
   current_pos.x = 0;
   if (current_pos.y >= ((63 - 0 + 1) / ((sizeof(font[0]) / sizeof(font[0][0])) + 1)))
    break;
  }
  if (str[i] == '\n') {
   ++current_pos.y;
...
static void print_char(char_point_t point, char c, char negative) {
 ...
 for (int y = 0; y < (sizeof(font[0]) / sizeof(font[0][0])); ++y) {
  for (int x = 0; x < (sizeof(font[0][0])); ++x) {
